...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSpacer = new QSpacerItem(511, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 684, 374));
